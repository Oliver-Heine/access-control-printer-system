...
public interface PrinterOperations {
     ...
     */
    void print(String filename, String printer, User user);
     ...
     */
    void queue(String printer, User user);
     ...
     */
    void topQueue(String printer, int job, User user);
     ...
     */
    void status(String printer, User user);
     ...
     */
    void readConfig(String parameter, User user);
     ...
     */
    void setConfig(String parameter, String value, User user);
}
